...
### [setup-securecheck](./setup-securecheck/) - セキュリティチェック
...
cp -r my-ai-collaboration-patterns/patterns/setup-pattern/setup-securecheck ./setup-securecheck
```
...
```
「setup-securecheck.md を読んで、段階的にセキュリティチェックを導入してください」
```
