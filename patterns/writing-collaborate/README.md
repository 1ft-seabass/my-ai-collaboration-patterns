...
>   collaborate/
>     ├── README.md
>     ├── actions/     # タスク自動化指示書（複数の.mdファイル含む）
>     ├── notes/
>     ├── letters/
>     └── tasks/
>
...
>
> 注: actions/ フォルダは本リポジトリの最新構成が含まれます。
> 具体的なファイルは collaborate/actions/README.md を参照してください。
>
...
- **4フォルダ構成**: actions・notes・letters・tasks のシンプル構成
- **執筆作業に最適化**: アクション・メモ・申し送り・タスクで執筆作業が回る
